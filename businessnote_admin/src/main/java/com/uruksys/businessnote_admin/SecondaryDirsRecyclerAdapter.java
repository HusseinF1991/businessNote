...
public class SecondaryDirsRecyclerAdapter extends RecyclerView.Adapter<SecondaryDirsRecyclerAdapter.MyViewHolder> implements View.OnClickListener, View.OnLongClickListener  {
    ...
    public void onClick(View view) {
        ...
        RecyclerView.LayoutManager mLayoutManager = new GridLayoutManager(myContext , 3);
    ...
    @NonNull
    @Override
    public SecondaryDirsRecyclerAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public int getItemCount() {return DirActivity.secondaryDirsModelArrayList.size();}
}
