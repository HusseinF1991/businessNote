...
public class ShowItemInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences sharedPref = ShowItemInfoActivity.this.getSharedPreferences("BusinessNoteSharedPrefereces", Context.MODE_PRIVATE);
        ...
        if (c.getCount() > 0) {
            if (c.moveToFirst()) {
                do {
                    ...
                    itemBoughtPrice = AES.decrypt(c.getString(c.getColumnIndex("boughtPrice")), dbSecretKey);
                    etxtItemBoughtPrice.setText(itemBoughtPrice + "");

                    itemSellPrice = AES.decrypt(c.getString(c.getColumnIndex("sellPrice")), dbSecretKey);
        ...
        btnUpdateItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (etxtItemName.getText().toString().trim().equals("") ||
                    ...
                    MySqliteDB mySqliteDB = new MySqliteDB(ShowItemInfoActivity.this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == AddNewItemActivity.CAMERA_REQUEST_IMAGE && resultCode == Activity.RESULT_OK) {
            ...
            try {
                ...
                itemImage = MainActivity.getBytesFromBitmap(resizedBitmap);
            ...
            try {
                ...
                itemAttachment = MainActivity.getBytesFromBitmap(resizedBitmap);
            ...
            try {
                ...
                if (selectedImage.getHeight() < 731 && selectedImage.getWidth() < 551) {
                    ...
                    itemImage = MainActivity.getBytesFromBitmap(selectedImage);
                } else {
            ...
            try {
                ...
                if (selectedImage.getHeight() < 731 && selectedImage.getWidth() < 551) {
                    ...
                    itemAttachment = MainActivity.getBytesFromBitmap(selectedImage);
                } else {
