...
public class AddNewItemActivity extends AppCompatActivity {
    ...
    public static final int WRITE_EXTERNAL_DATA_PERMISSION_CODE = 105;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CAMERA_REQUEST_IMAGE && resultCode == Activity.RESULT_OK) {
            ...
            try {
                ...
                itemImageStr = MainActivity.getBytesFromBitmap(resizedBitmap);

                //remove image from storage
                //File myFile = new File(UriUtils.getPathFromUri(getApplicationContext(), itemImageUri));
                //myFile.delete();
                //itemImageUri = null;
            ...
            itemImageStr = MainActivity.getBytesFromBitmap(photo);*/
            ...
            try {
                ...
                itemAttachmentStr = MainActivity.getBytesFromBitmap(resizedBitmap);


                //remove image from storage
                //File myFile = new File(UriUtils.getPathFromUri(getApplicationContext(), itemAttachmentUri));
                //myFile.delete();
            ...
            //itemAttachmentStr = MainActivity.getBytesFromBitmap(photo);
            ...
            try {
                ...
                if (selectedImage.getHeight() < 731 && selectedImage.getWidth() < 551) {
                    ...
                    itemImageStr = MainActivity.getBytesFromBitmap(selectedImage);
                } else {
            ...
            try {
                ...
                if (selectedImage.getHeight() < 731 && selectedImage.getWidth() < 551) {
                    ...
                    itemAttachmentStr = MainActivity.getBytesFromBitmap(selectedImage);
                } else {
        ...
        btnAddNewItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (etxtNewItemName.getText().toString().trim().equals("") ||
                    ...
                    SharedPreferences sharedPref = AddNewItemActivity.this.getSharedPreferences("BusinessNoteSharedPrefereces", Context.MODE_PRIVATE);
                    ...
                    String boughtPrice = AES.encrypt(etxtNewItemBoughtPrice.getText().toString(), dbSecretKey);
                    String sellPrice = AES.encrypt(etxtNewItemSellPrice.getText().toString(), dbSecretKey);
                    String supplier = etxtNewItemSupplier.getText().toString().trim();
                    String notes = etxtNewItemNotes.getText().toString().trim();

                    MySqliteDB mySqliteDB = new MySqliteDB(AddNewItemActivity.this);
