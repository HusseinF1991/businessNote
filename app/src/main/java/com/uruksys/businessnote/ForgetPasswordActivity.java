...
public class ForgetPasswordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences sharedPref = ForgetPasswordActivity.this.getSharedPreferences("BusinessNoteSharedPrefereces", Context.MODE_PRIVATE);
                ...
                builder.setMessage("سيتم حذف الحساب الحالي لتسجيل حساب جديد, للاستمرار اضغط موافق")
                        .setPositiveButton("موافق", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                editor.putString("BusinessNoteUserNameSharedPrefereces", "");
                                editor.putString("BusinessNotePasswordSharedPrefereces", "");
                                editor.commit();
